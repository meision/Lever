...
namespace Meision.Resources
{
    static partial class SR
    {
        ...
        private static Dictionary<string, string[]> GetLanguages()
        {
            ...
            Dictionary<string, string[]> languages = new Dictionary<string, string[]>(283);
            ...
            value[3] = @"";
            languages.Add(key, value);
            key = @"ByteStream_SeekBeforeBegin";
            value = new string[4];
        ...
        /// </summary>
        public static string ByteStream_SeekBeforeBegin
        {
            get
            {
                return SR.GetStringInternal("ByteStream_SeekBeforeBegin", Thread.CurrentThread.CurrentUICulture);
            }
        }
        ...
        /// Stream was too long.
        /// </summary>
        public static string ByteStream_StreamTooLong
        {
            get
            {
                return SR.GetStringInternal("ByteStream_StreamTooLong", Thread.CurrentThread.CurrentUICulture);
            }
        }
