...
namespace Meision.VisualStudio.CustomTools
{
    ...
    {
        private IVsGeneratorProgress _vsGeneratorProgress;
        /// <summary>
        /// Interface to the VS shell object we use to tell our progress while we are generating
        /// </summary>
        internal IVsGeneratorProgress VSGeneratorProgress
        {
            get
            {
                return _vsGeneratorProgress;
            }
        }
        ...
        /// </summary>
        internal protected string CodeNamespace
        {
            get
            {
        ...
        /// </summary>
        internal protected string InputFilePath
        {
            get
            {
        ...
        int IVsSingleFileGenerator.Generate(string wszInputFilePath, string bstrInputFileContents, string wszDefaultNamespace, IntPtr[] rgbOutputFileContents, out uint pcbOutput, IVsGeneratorProgress pGenerateProgress)
        {
            ...
            _inputFilePath = wszInputFilePath;
            _codeNamespace = wszDefaultNamespace;
            _vsGeneratorProgress = pGenerateProgress;

            byte[] bytes = GenerateData(bstrInputFileContents);
        ...
        /// <summary>
        /// The method that does the actual work of generating code or data given the input file
        /// </summary>
        /// <param name="inputFileContent">File contents as a string</param>
        /// <returns>The generated code file as a byte-array</returns>
        protected abstract byte[] GenerateData(string inputFileContent);
        ...
        {
            IVsGeneratorProgress progress = VSGeneratorProgress;
            if (progress != null)
            {
